...
这是一个基于 PySide6 和 [Sherpa-Onnx](https://github.com/k2-fsa/sherpa-onnx) 开发的实时语音识别和AI翻译的桌面应用，能够将你的中文（及中英混合）语音实时转换为带标点符号的文字，且支持同步翻译。它非常适合用于会议记录、课堂笔记、语音写作等场景。

本项目是基于https://github.com/jianchang512/realtime-stt/tree/main的修改，增加以下功能：
1、可选是系统声音还是麦克风声音，或者2者。
2、增加实时翻译功能，增加时间戳功能，在写入识别原文的同时，写入翻译结果。
3、增加结束录音后，优化翻译功能。
4、清除内容的时候，默认导出识别的原文和翻译。

计划新增的功能：
1、增加AI会议纪要功能，会议纪要可选语言
2、
